const PointsOfInterest = {
    BuildingFilters: [
        // keywords = the values for the "building" attributes in the "Points" array
    ...
    FloorFilters: [
        // keywords = the values for the "floor" attributes in the "Points" array
        { keyword: '', display: 'No Filter' },
    ...
    Points: [
        {
            ...
            type: 'multiple',
            floor: [
                { floor: '1st', name: 'SLU Band Room', class: 'other' },
        ...
        },
        {
            ...
            floor: [
                { floor: '1st', name: 'Faculty Room - Philosophy' },
        ...
        },
        {
            ...
            type: 'multiple_similar',
            floor: [
                { floor: '3rd', name: 'Conference Room - STELA' },
        ...
        },
        {
            ...
            type: 'multiple',
            floor: [
                { floor: '1st', name: 'Equipment and Work Room', class: 'other' },
...

        {
            ...
            type: 'multiple_similar',
            floor: [
                { floor: '4th', name: 'Faculty Room 1 - Physical Education' },
        ...
        },
        {
            ...
            type: 'multiple_similar',
            floor: [
                { floor: '5th', name: 'Philosophy and Psychology Library | Language Library | Pure Science Library' },
        ...
        },
        {
            ...
            type: 'multiple_similar',
            floor: [
                { floor: '5th', name: 'Religion Library' },
        ...
        },
        {
            ...
            type: 'multiple_similar',
            floor: [
                { floor: '5th', name: 'Social Sciences Library' },
        ...
        },
        {
            ...
            type: 'multiple',
            floor: [
                { floor: '1st', name: 'Foundry Room', class: 'other' },
        ...
        },
        {
            ...
            type: 'multiple',
            floor: [
                { floor: '1st', name: 'Materials Testing Laboratory', class: 'lab' },
        ...
        },
        {
            ...
            type: 'multiple',
            floor: [
                { floor: '1st', name: 'Faculty Room - Civil/Geodetic Engineering', class: 'faculty' },
        ...
        },
        {
            ...
            type: 'multiple',
            floor: [
                { floor: '1st', name: 'Mechanical Engineering Office', class: 'office' },
                { floor: '2nd', name: 'Faculty Room - Mechanical Engineering', class: 'faculty' },
                { floor: '3rd', name: 'Faculty Room - Electronics Engineering', class: 'faculty' },
